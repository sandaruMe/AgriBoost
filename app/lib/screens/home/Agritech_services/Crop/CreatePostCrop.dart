...
import '../../../../services/DatabaseService_crop.dart';
import '../../../../services/DatabaseService_soil.dart';
import '../../../../services/databace_notification.dart';
import '../../../../services/database_news.dart';



class CreatecroplPostPage extends StatefulWidget {


  @override
  _CreatecroplPostPageState createState() => _CreatecroplPostPageState();
}

class _CreatecroplPostPageState extends State<CreatecroplPostPage> {
  ...
  Future<String?> _uploadImage(File image) async {
    try {
      String filePath =
          'Soil_images/'+'Agritech_Soil_${DateTime.now().millisecondsSinceEpoch}.jpg';
  ...
  Future<void> createPost(String postText, String heading ,String? imageUrl) async {
    ...
    await DatabaseService_crop(docname: 'News_Post_${datetimenow}')
        .updateUserData( postText, heading,imageUrl);

    await notification_service(uid: 'Crop_not_${datetimenow}')
        .updateUserData("Agri Tech SriLanka", "Added Crop management Item",logo);
  }
