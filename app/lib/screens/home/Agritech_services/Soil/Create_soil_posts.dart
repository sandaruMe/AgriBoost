...
class CreateSoilPostPage extends StatefulWidget {


  @override
  _CreateSoilPostPageState createState() => _CreateSoilPostPageState();
}

class _CreateSoilPostPageState extends State<CreateSoilPostPage> {
  ...
  Future<void> createPost(String postText, String heading ,String? imageUrl) async {
    ...
    await DatabaseService_soil(docname: 'News_Post_${datetimenow}')
        .updateUserData( postText, heading,imageUrl);

    await notification_service(uid: 'Soil_not_${datetimenow}')
        .updateUserData("Agri Tech SriLanka", "Add Soil management Item",logo);
  }
